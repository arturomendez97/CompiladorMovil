...
// HAcer pop de las dos expresiones más recientes
  ...
  static final public void creaCuadruploExpPointer(Token func) throws ParseException {Token op;
...
op = TokenAsignaciones.popPilaOP();
    ...
    temporal.kind = TokenAsignaciones.getCuboType(aux, aux2, op.image);
        ...
        TokenAsignaciones.aumentaVarFuncTempotalPointer(func);
    ...
    temporal.image = String.valueOf(TokenAsignaciones.getContTemporalPointer());
    System.out.println("TEMPORAL POINTER IMAGE: " + temporal.image);
